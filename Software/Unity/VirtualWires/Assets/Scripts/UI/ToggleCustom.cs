...
namespace UnityEngine.UI
{
    ...
    public class ToggleCustom : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        ...
        [SerializeField]
        private ToggleGroupCustom
            m_Group;
        
        public ToggleGroupCustom group
        {
            get { return m_Group; }
            set
            {
        ...
        {
            ToggleGroupCustom oldGroup = m_Group;
